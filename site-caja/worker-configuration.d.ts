/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8949704f9947f6a3cb9669c62347d1ca)
// Runtime types generated with workerd@1.20260918.1 2026-09-18 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_Env {
	PEDIDOS_DB: D1Database;
	...
	VISITAS: DurableObjectNamespace<import("./worker/index").VisitasCounter>;
	PEDIDO_REF: DurableObjectNamespace<import("./worker/index").PedidoContador>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "VisitasCounter" | "PedidoContador";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "SITE_INDEXABLE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD">> {}
}
